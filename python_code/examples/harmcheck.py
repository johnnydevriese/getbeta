# this function computes the eigenvalues and eigenvectors of the 1d discrete harmonic oscillator
...
K = 7
D,V = sparse.linalg.eigsh(.5*fd.lap1d0(N,hn)+fd.xsquared1d(L,N),k=K,sigma=0.0,return_eigenvectors=True)
